...
| | 옵니다 | 안 옵니다 |
|---|---|---|
| 캘린더 → Clear Week | **할 일(TODO)** 중 안 끝난 것 · **저쪽에서 지워 사라진 것** | 완료한 것 · 아이디어 · 가계부 · 반복 일정 · 고친 글자 |
| Clear Week → 캘린더 | — **아무것도 안 갑니다** | 적은 것 · 지운 것 · 취소선 · 고친 글자 · note 칸 |

**Clear Week에서 한 일은 캘린더에 영향을 주지 않습니다.** 여기서 적고, 긋고,
지워도 캘린더의 일정은 그대로입니다. 일정의 원본은 캘린더에 있고, 주간표는
그중 이번 주 것을 종이 위에 펼쳐 보는 자리입니다.

여기서 지운 것은 **이쪽에서만** 사라지고, 다시 받아 와도 되살아나지 않습니다.

**옮기기는 지원 안 됩니다** — 캘린더에서 항목을 다른 주로 옮기면 이 주에서는
지운 것으로 보입니다. 저쪽에서 옮긴 뒤에는 새로 만들면 됩니다.

**받아 오는 때**는 주를 옮길 때와 로그인 직후입니다. 보고 있는 주에 새 일정이
생겼으면 **아래로 당겨** 새로 받으면 됩니다.
...
- **Clear Week에서 적은 것이 캘린더에 안 생긴다** → 그게 맞습니다. 한 방향입니다.
